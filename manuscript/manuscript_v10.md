# Terminal Low-Complexity Regions as a General Architectural Property of Proteins: A Positional and Compositional Fingerprint Across 772 Proteomes and 43 Lineages
...
The positional distribution of LCRs *within* proteins — where along the sequence they sit — has received far less attention than their prevalence or functional roles, yet it is a basic feature of protein architecture. Coletta and colleagues (2010) were the first to ask this question: using a single yeast (*Saccharomyces cerevisiae*) proteome, they showed that LCRs are significantly enriched near sequence extremities (p = 7.6 × 10⁻⁶) and that terminal versus central LCR position correlates with distinct functional roles (terminal LCRs: protein connectivity; central LCRs: transcription). This observation was not extended beyond yeast. Teekas and colleagues (2024) revisited the question at scale, reporting that across 308 Tetrapoda species (12 clades) LCRs are significantly enriched in the terminal 5% of protein sequences (the first and last bins of a 20-bin positional map), with 15–25% of all LCRs in terminal positions despite these bins representing only 10% of positional space. This enrichment co-occurred with positively selected sites and was consistent across birds, mammals, reptiles, and amphibians. Outside Tetrapoda, however, the positional question remains largely unexamined: no systematic test has been reported for the invertebrate animal phyla, for any eukaryotic supergroup beyond fungi and animals, or — as set out below — across prokaryotic proteomes.

In prokaryotes, LCRs are functionally significant and evolutionarily conserved (Ntountoumi et al. 2019), and their formation is compensatorily related to gene duplication — LCR-forming short repeats serve as a transient short-term adaptive mechanism that fades as gene paralogy accumulates (Persi et al. 2023; Saravanan et al. 2025). These studies characterised LCR prevalence, amino acid composition, and gene-level evolutionary context across thousands of bacterial proteomes, but did not analyse position along the sequence. One positional observation does exist, and it motivates the present work: in a dedicated analysis of *ribosomal* proteins, Ntountoumi et al. (2019) observed that "the vast majority of the bacterial and archaeal ribosomal LCRs were located at the C-terminus of their proteins". That finding establishes that prokaryotic LCRs *can* be strongly positionally biased, but leaves open whether it reflects a property peculiar to ribosomal proteins — a family under exceptional structural and translational constraint — or the visible edge of a proteome-wide pattern of the kind described in eukaryotes. Distinguishing these requires positional analysis applied across whole prokaryotic proteomes rather than to a single protein family, which has not been done.

The outcome of such a test does not, by itself, adjudicate between an architectural and a degradation-driven explanation. Prokaryotes possess their own terminally acting targeting and proteostasis machinery — N-terminal signal peptides and export sequences, C-terminal ssrA (tmRNA-mediated) degradation tags (Keiler et al. 1996), and a ClpS/ClpAP N-end-rule pathway (Erbse et al. 2006) — analogous in placement to, though non-homologous with, the eukaryotic ubiquitin-proteasome degron system. Terminal enrichment in bacteria and archaea would therefore exclude a strictly eukaryote-specific ubiquitin-proteasome explanation, but not a convergent one assembled from prokaryote-specific terminal machinery. What discriminates among the remaining possibilities is not the *presence* of the pattern but its **fingerprint**: which residues dominate terminal LCRs, and whether N-versus-C polarity is uniform across lineages or instead tracks the terminal biology particular to each. We therefore treat taxonomic breadth and compositional/directional fingerprint as two separate lines of evidence.

Several further questions of generality follow. First, published positional work covers only a narrow slice of animal diversity: outside Tetrapoda, phyla such as Porifera, Xenacoelomorpha, Tardigrada, Rotifera, Nemertea, Nematomorpha, and Collembola have never been tested. Second, positional analysis outside Opisthokonta is essentially absent, leaving most eukaryotic supergroups — including the entire SAR supergroup — unexamined. Third, prokaryotic proteomes carry few LCRs per species (a median of roughly 20 in bacteria), so any individual-species Fisher's test is underpowered by construction; resolving the prokaryote question requires pooling at scale.

Here we address these questions by scaling the analysis to 772 proteomes spanning 43 phyla/groups and all three domains of life, encompassing 1,004,572 LCRs. We ask: (1) Does the C-terminal positional bias reported for prokaryotic ribosomal proteins (Ntountoumi et al. 2019) generalise to proteome-wide terminal LCR enrichment in bacteria and archaea, and does it survive protein-length confound controls? (2) Does the signal span all major eukaryotic supergroups, establishing terminal enrichment as domain-independent? (3) Does terminal enrichment hold across all metazoan phyla tested here? (4) Is the N/C asymmetry of terminal LCRs a single universal pattern, or is polarity lineage-specific — and, if lineage-specific, what does its variation reveal about the underlying mechanism? Rather than dating the origin of the property, we treat its breadth as evidence of *generality* and use the amino-acid identity and directional polarity of terminal LCRs as a mechanistic fingerprint.
...
A total of 772 proteomes were assembled from three sources: (1) Ensembl Metazoa release 63 (metazoan invertebrate species); (2) Ensembl Plants and Ensembl release 110 (Viridiplantae, algae, and additional fungi); (3) UniProt reference proteomes (2024 release; UniProt Consortium 2023) for additional eukaryotes and all prokaryotes. Species were selected to maximise taxonomic breadth within each major lineage. The full list is provided in Supplementary Table S1.

Metazoan sampling represents 24 phyla, including Porifera, Xenacoelomorpha, Tardigrada, Rotifera, Collembola, Nematomorpha, and Nemertea, which extend positional analysis across the diversity of the animal tree. Phyla represented by a single species (Brachiopoda, Priapulida, Chordata/Cephalochordata, Acanthocephala, Nematomorpha) are flagged throughout as providing single data points rather than phylum-level confirmations; their enrichment values should be interpreted with appropriate caution until additional species are included.

Non-metazoan eukaryote sampling spans all recognised eukaryotic supergroups: Opisthokonta (Fungi: 11 sp.); SAR–Stramenopiles (Oomycota: 26 sp., Bacillariophyta: 5 sp.); SAR–Alveolata (Apicomplexa: 43 sp., Ciliophora: 7 sp., Perkinsozoa: 1 sp.); SAR–Rhizaria (3 sp.); Excavata–Euglenozoa (16 sp.); Excavata–Metamonada (6 sp.); Excavata–Heterolobosea (1 sp.); Amoebozoa (10 sp.); Archaeplastida–Viridiplantae (132 sp.); Archaeplastida–Rhodophyta (3 sp.); Archaeplastida–Chlorophyta (6 sp.); Haptophyta (1 sp.); Cryptophyta (3 sp.); and a residual Protist category (diverse) representing lineages not assigned to the above named groups. The Apicomplexa species include multiple *Plasmodium*, *Eimeria*, *Cryptosporidium*, *Babesia*, *Theileria*, *Hammondia*, and *Toxoplasma* representatives. The Viridiplantae species cover all major angiosperm orders together with representatives of every intervening grade: *Ceratopteris richardii* and *Adiantum capillus-veneris* (ferns), *Taxus chinensis*, *Cryptomeria japonica* and *Pinus longaeva* (conifers), *Selaginella* and *Diphasiastrum* (lycophytes), *Physcomitrium*, *Marchantia*, *Sphagnum* and *Ceratodon* (bryophytes), and charophyte and chlorophyte algae (*Chara braunii*, *Klebsormidium nitens*, *Closterium*, *Volvox*, *Micromonas*, *Chlorella*, *Coccomyxa*). Fern and gymnosperm sampling is necessarily narrow — both ferns are Pteridaceae and all three gymnosperms are conifers, because *Ginkgo*, cycads and Gnetales lack protein-level genome annotation in public archives. Choanoflagellates, the unicellular sister group to Metazoa, are absent from the current dataset; their inclusion would extend the generality test and is a priority for a subsequent revision (see Discussion).
...
Positional binning, terminal LCR definition, species-level Fisher's exact test, and protein-level sensitivity analysis follow the framework of Teekas et al. (2024): each protein is divided into 20 equal-length positional bins, an LCR is scored as terminal if it falls in bin 1 or bin 20, and terminal enrichment is tested against a 10% positional null (2 of 20 bins) with a one-sided Fisher's exact test. Phylum-level summaries pool all LCRs from member species before applying Fisher's test. Pooled enrichment is reported as an odds ratio relative to the 10% positional null; p-values are reserved for genuinely bounded per-test comparisons. All statistical tests were computed in Python using SciPy (Virtanen et al. 2020).
...
The length-stratified analysis was extended to Bacteria, Archaea, and all eukaryotic lineages. Protein-length quartile boundaries were defined once across the pooled host-protein lengths of the entire dataset — a single global length scale, not per-domain, per-phylum, or per-species — and the same boundaries were then applied within every group so that quartiles are directly comparable across domains. Because prokaryotic proteins are short, bacterial and archaeal LCRs are concentrated in the lower global quartiles. LCRs were then assigned to quartiles by their host protein's length, and Fisher's exact test for terminal enrichment applied within each quartile. This tests whether terminal enrichment is driven by short proteins mechanically populating terminal bins.
...
We report the first systematic, proteome-wide test of LCR position in prokaryotes. Prior positional evidence in these domains was confined to the C-terminal localisation of LCRs in bacterial and archaeal ribosomal proteins (Ntountoumi et al. 2019); we find that terminal enrichment is not restricted to that family but holds across the proteome in both domains — establishing terminal enrichment as a property of protein architecture that is not confined to eukaryotes.
...
|---|---|---|---|---|
| Bacteria | 21.16%*** | 30.45%*** | 36.67%*** | 28.31%*** |
| Archaea | 20.58%*** | 26.80%*** | 37.33%*** | 30.95%* |
...
Across all 772 analysed species, 1,004,572 LCRs were analysed. The U-shaped LCR positional profile (bins 1 and 20 elevated relative to internal bins) is visually apparent across species in the bin heatmap (Figure 1) and the per-phylum profile overlay (Figure 3).

After Holm-Bonferroni correction across 43 phylum-level tests, pooled terminal enrichment is significant in **41 of 43** phyla/groups (Table 1; Table 2; Figure 2). Two groups do not survive correction and are treated as underpowered: **Acanthocephala** (p_raw = 0.071 → 0.091) and **Nematomorpha** (0.046 → 0.091), each represented by a single species. Both algal groups now clear the corrected threshold — Chlorophyta comfortably (p_holm < 0.001, on 6 species) and Rhodophyta marginally (p_raw = 0.015 → 0.044). Within Metazoa, 22 of 24 phyla survive correction (Acanthocephala and Nematomorpha fail, both single-species and small). Several phyla remain represented by a single species; their enrichment values are indicative data points rather than phylum confirmations.
...
Every major eukaryotic lineage tested shows significant pooled terminal enrichment after Holm-Bonferroni correction, with no exceptions. The two algal groups that were previously provisional now clear the threshold: Chlorophyta on expanded sampling (6 species, p_holm < 0.001) and Rhodophyta marginally (p_holm = 0.044, 3 species, still worth additional species). Table 2 lists corrected significance and includes Heterolobosea (Excavata).
...
Euglenozoa (16 spp.) and Metamonada (6 spp.) are among the earliest-diverging eukaryotic clades; their significant enrichment (18.3% and 18.6%) shows the property is not restricted to crown eukaryotes. Heterolobosea, represented by a single species, shows the highest eukaryotic terminal fraction in the dataset (31.0%) and is reported here as a single data point.
...
**Chlorophyta and Rhodophyta** (12.3% and 13.2%): the lowest observed enrichment levels, though both are now significant after multiple-testing correction. Expanding Chlorophyta from 2 to 6 species reveals wide within-group spread — *Volvox carteri* (10.5%) and *Chlamydomonas reinhardtii* (10.7%) sit at the bottom, whereas *Chlorella variabilis* (18.4%), *Coccomyxa subellipsoidea* (18.1%) and *Ostreococcus lucimarinus* (26.7%) fall within or above the typical eukaryotic range. The low pooled value is therefore driven by the two volvocine green algae rather than being characteristic of Chlorophyta as a whole. Rhodophyta (3 species, p_holm = 0.044) remains marginal and would benefit from further sampling.
...
Driver analysis separates the two protein classes cleanly: singleton-LCR proteins drive enrichment in 41 of 42 phyla/groups, and multi-LCR proteins contribute significantly in 29 of 42. GO enrichment was significant in the five species with BioMart-compatible annotations; the absence of functional concentration in terminal LCRs across well-annotated metazoan species is consistent with a mechanism acting on protein architecture regardless of gene function.
...
The 132-species plant dataset confirms strong N-terminal polarity in Viridiplantae and shows an apparent gradient in tier means — near-balanced in bryophytes, intermediate in eudicots, extreme in grasses (3.5–4.5). This apparent gradient must, however, be interpreted cautiously: a Brownian-motion PGLS on evolutionary tier does not recover a significant slope (0.253, p = 0.185, R² = 0.018, n = 100 genera) despite a strong non-phylogenetic correlation (Pearson r = 0.59, p < 0.001). The regression now spans the complete ten-tier ladder, ferns and gymnosperms included, so the negative result no longer rests on a predictor with unsampled intermediate tiers. The raw correlation is substantially inflated by the phylogenetic clustering of the large, closely related grass and eudicot samples; a per-lineage evolutionary gradient is not robustly supported once shared ancestry is modelled. We report this negative result explicitly as a rigor check: the supergroup-level N-dominance of land plants is robust, but the fine-grained mosses-to-grasses "gradient" is not. If the PRT6/PCO N-degron pathway contributed the plant N-terminal polarity, its substrates would be expected to carry N-terminal LCRs; however, the per-domain composition analysis shows Viridiplantae termini dominated by leucine and methionine rather than the cysteine/arginine residues these pathways recognise, so any PRT6/PCO contribution is not the primary compositional signature of plant terminal LCRs.
...
**Platyhelminthes** (14.6% terminal; C-dominant, median 0.54) shows the lowest metazoan terminal enrichment; sampling of 7 species indicates this is a genuine phylum-level property rather than a single-species anomaly. The systematic C-terminal bias, particularly in *Schistosoma*, contrasts with other lophotrochozoans and is mechanistically unexplained.

**Chlorophyta and Rhodophyta** now survive Holm-Bonferroni correction, Chlorophyta decisively on expanded sampling and Rhodophyta marginally (p_holm = 0.044); the earlier provisional status of both reflected sampling depth rather than a genuinely absent signal. **Acanthocephala** and **Nematomorpha** remain the only two groups that fail correction; both are single-species phyla failing on power grounds, and their effect sizes are within the bilaterian range.
...
2. **fLPS parameter sensitivity.** A three-parameter sensitivity analysis (Supplementary Table S6) confirms that SINGLE-type terminal enrichment is robust to the LCR length threshold and purity cutoff. Prokaryote terminal enrichment persists and in fact strengthens under stringent parameters (length ≥6, purity ≥80%: Bacteria 34.14%, Archaea 29.01%) and remains significant under relaxed parameters (length ≥3, purity ≥60%: Bacteria 23.98%, Archaea 22.36%). Terminal enrichment does not extend to MULTI-type LCRs (Bacteria 9.06%, Archaea 11.34%; both non-significant), indicating the signal is specific to the most compositionally extreme, single-residue-dominated regions. Under the stringent setting six already-weak groups (Metamonada, Rhodophyta, Haptophyta, Priapulida, Chordata, Nematomorpha) lose significance; this caveat qualifies those specific groups but not the prokaryote or well-sampled eukaryote results.

3. **Multiple testing.** Holm-Bonferroni correction was applied to all 43 phylum-level tests; 41 survive. Only Acanthocephala and Nematomorpha do not; both are single-species groups and are treated as provisional/underpowered. The expanded algal sampling (Chlorophyta 2 → 6 species) brings Chlorophyta and Rhodophyta above the corrected threshold, where earlier they were not.

4. **Single-species groups.** Several phyla and protist lineages (including Heterolobosea) are represented by one species. These provide initial data points but not phylum-level confirmations, and the domain aggregates should not be over-read as species-typical.
...
6. **GO enrichment gap.** GO analysis covers only 5 of 772 species (BioMart compatibility); prokaryote GO enrichment via UniProt flat-file annotations is planned.
...
Applying a single positional framework to 772 proteomes spanning 43 phyla/groups and all three domains of life (1,004,572 LCRs), we show that terminal LCR enrichment is a general architectural property of proteins rather than a eukaryote-specific one. Pooled bacteria (27.6%, OR 3.43, 92 species) and archaea (25.7%, OR 3.13, 27 species) are terminally enriched — to our knowledge the first systematic, proteome-wide positional analysis of LCRs in prokaryotes — and the enrichment is not explained by protein length: it increases across length quartiles in the direction opposite to a length artefact and is robust to species-level clustering (GEE, bootstrap) and to parameter choice (sensitivity analysis). Across eukaryotes, every major supergroup is represented and 41 of 43 phyla/groups survive Holm-Bonferroni correction (only Acanthocephala and Nematomorpha, both single-species groups, remain provisional/underpowered). Singleton-LCR proteins drive the signal in 41 of 42 groups; multi-LCR proteins contribute in 29 of 42.
...
Alberti S, Gladfelter A, Mittag T (2019). Considerations and challenges in studying liquid-liquid phase separation and biomolecular condensates. *Cell* 176:419–434. doi:10.1016/j.cell.2018.12.035

Boija A, et al. (2018). Transcription factors activate genes through the phase-separation capacity of their activation domains. *Cell* 175:1842–1855. doi:10.1016/j.cell.2018.10.042

Coletta A, Pinney JW, Solís DY, Marsh J, Pettifer SR, Attwood TK (2010). Low-complexity regions within protein sequences have position-dependent roles. *BMC Systems Biology* 4:43. doi:10.1186/1752-0509-4-43

Erbse A, Schmidt R, Bornemann T, Schneider-Mergener J, Mogk A, Zahn R, Dougan DA, Bukau B (2006). ClpS is an essential component of the N-end rule pathway in *Escherichia coli*. *Nature* 439:753–756. doi:10.1038/nature04412

Gibbs DJ, Lee SC, Isa NM, Gramuglia S, Fukao T, Bassel GW, Correia CS, Corbineau F, Theodoulou FL, Bailey-Serres J, Holdsworth MJ (2011). Homeostatic response to hypoxia is regulated by the N-end rule pathway in plants. *Nature* 479:415–418. doi:10.1038/nature10534

Harrison PM (2017). fLPS: Fast discovery of compositional biases for the protein universe. *BMC Bioinformatics* 18:476. doi:10.1186/s12859-017-1906-3

Holdsworth MJ, Vicente J, Sharma G, Abbas M, Zubrycka A (2020). The plant N-degron pathways of ubiquitin-mediated proteolysis. *Journal of Integrative Plant Biology* 62:70–89. doi:10.1111/jipb.12882

Irastortza-Olaziregi M, Amster-Choder O (2021). Coupled transcription-translation in prokaryotes: an old couple with new surprises. *Frontiers in Microbiology* 11:624830. doi:10.3389/fmicb.2020.624830

Janke C, Magiera MM (2020). The tubulin code and its role in controlling microtubule properties and functions. *Nature Reviews Molecular Cell Biology* 21:307–326. doi:10.1038/s41580-020-0214-3

Keiler KC, Waller PR, Sauer RT (1996). Role of a peptide tagging system in degradation of proteins synthesized from damaged messenger RNA. *Science* 271:990–993. doi:10.1126/science.271.5251.990

Koren I, Timms RT, Kula T, Xu Q, Li MZ, Elledge SJ (2018). The eukaryotic proteome is shaped by E3 ubiquitin ligases targeting C-terminal degrons. *Cell* 173:1622–1635. doi:10.1016/j.cell.2018.04.028
...
Marcotte EM, Pellegrini M, Yeates TO, Eisenberg D (1999). A census of protein repeats. *Journal of Molecular Biology* 293:151–160. doi:10.1006/jmbi.1999.3136

Muralidharan V, Goldberg DE (2013). Asparagine repeats in *Plasmodium falciparum* proteins: Good for nothing? *PLoS Pathogens* 9:e1003488. doi:10.1371/journal.ppat.1003488

Ntountoumi C, Vlastaridis P, Mossialos D, Stathopoulos C, Iliopoulos I, Promponas V, Oliver SG, Amoutzias GD (2019). Low complexity regions in the proteins of prokaryotes perform important functional roles and are highly conserved. *Nucleic Acids Research* 47(19):9998–10009. doi:10.1093/nar/gkz730

Pechmann S, Frydman J (2013). Evolutionary conservation of codon optimality reveals hidden signatures of cotranslational folding. *Nature Structural & Molecular Biology* 20:237–243. doi:10.1038/nsmb.2466

Persi E, Wolf YI, Karamycheva S, Makarova KS, Koonin EV (2023). Compensatory relationship between low-complexity regions and gene paralogy in the evolution of prokaryotes. *Proceedings of the National Academy of Sciences* 120:e2300154120. doi:10.1073/pnas.2300154120

Piatkov KI, Vu TTM, Hwang C-S, Varshavsky A (2015). Formyl-methionine as a degradation signal at the N-termini of bacterial proteins. *Microbial Cell* 2(10):376–393. doi:10.15698/mic2015.10.231
...
Saravanan V, Kravetz A, Battistuzzi FU (2025). Higher frequency of prokaryotic low complexity regions in core and orthologous genes. *Frontiers in Bioinformatics* 5:1673480. doi:10.3389/fbinf.2025.1673480
...
Teekas L, Sharma S, Vijay N (2024). Terminal regions of a protein are a hotspot for low complexity regions and selection. *Open Biology* 14:230439. doi:10.1098/rsob.230439

UniProt Consortium (2023). UniProt: the Universal Protein Knowledgebase in 2023. *Nucleic Acids Research* 51:D523–D531. doi:10.1093/nar/gkac1052

van der Lee R, et al. (2014). Classification of intrinsically disordered regions and proteins. *Chemical Reviews* 114:6589–6631. doi:10.1021/cr400525m

Varshavsky A (2019). N-degron and C-degron pathways of protein degradation. *Proceedings of the National Academy of Sciences* 116:358–366. doi:10.1073/pnas.1816596116

Vernon RM, Chong PA, Tsang B, Kim TH, Bah A, Farber P, Lin H, Forman-Kay JD (2018). Pi-pi contacts are an overlooked protein feature relevant to phase separation. *eLife* 7:e31486. doi:10.7554/eLife.31486
...
Wootton JC, Federhen S (1996). Analysis of compositionally biased regions in sequence databases. *Methods in Enzymology* 266:554–571. doi:10.1016/s0076-6879(96)66035-2

---

## Figure Legends

**Figure 1. LCR positional distribution across 772 proteomes.** Heatmap showing the fraction of LCRs in each of 20 equally spaced positional bins (bin 1 = N-terminal 5%; bin 20 = C-terminal 5%) for each analysed species. Rows ordered by domain and phylum (Bacteria → Archaea → non-metazoan eukaryotes → Metazoa). Colour scale: fraction of a species' LCRs in that bin (0–0.15). Dashed blue lines mark the terminal bins.

**Figure 2. Terminal LCR enrichment by phylum.** Bar chart showing pooled % terminal LCRs per phylum/group, ordered by lineage. Black dots show individual-species values. Red dotted line: 10% null expectation. Grey shaded band: Tetrapoda range from Teekas et al. (2024; 15–25%). Forty-one of 43 groups significantly exceed the null after Holm-Bonferroni correction; the two exceptions (Acanthocephala, Nematomorpha) are single-species and underpowered/provisional. Bacteria (27.6%) and Archaea (25.7%) show among the highest pooled terminal fractions.
...
**Supplementary Table S1.** Full species list (772 entries): species name, phylum, data source (Ensembl / UniProt), proteome ID, protein count, LCR count, pct_terminal.
...
**Supplementary Figure 7.** PGLS regression of N/C asymmetry ratio on evolutionary tier across 84 Viridiplantae genus representatives, under a Brownian-motion model on a time-calibrated backbone phylogeny. Contrasts the strong non-phylogenetic correlation (OLS/Pearson r = 0.59, p < 0.001) with the non-significant phylogenetically-corrected slope (PGLS slope = 0.253, p = 0.185, R² = 0.018, n = 100 genera across all ten tiers).
